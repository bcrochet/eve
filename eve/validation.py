...
class Validator(cerberus.Validator):
    ...
    def __init__(self, *args, **kwargs):
        kwargs['error_handler'] = DefaultErrorHandler
...
class DefaultErrorHandler(cerberus.errors.BasicErrorHandler):
    ...
    lists, even in the case of a single error. To maintain compatibilty with
    ...
    def pretty_tree(self):
        pretty = super(DefaultErrorHandler, self).pretty_tree
